  ...
  return (
    <div className="card mt-16 lg:mt-0 rounded-full overflow-hidden">
      <div className="flex   lg:*:h-[50px] *:h-[35px]">
        ...
        <input placeholder="title" className="bg-transparent focus:bg-slate-200 focus:text-black text-white w-full text-xl bg-slate-300 outline-none focus:ring-1 px-5 focus:ring-orange-500" type="text" id="title" />
